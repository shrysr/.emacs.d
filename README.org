...
# [[nb:.emacs.d::emacs-config.org::c496][Introduction:1]]
...
# [[nb:.emacs.d::emacs-config.org::c1586][Overall setup:1]]
...
# [[nb:.emacs.d::emacs-config.org::c3916][Inspirations (and other literate configurations):1]]
...
# [[nb:.emacs.d::emacs-config.org::c4938][Packages I've found very useful:1]]
