...
years. However, Scimax is more of an application and one that is customise to
specific needs. This configuration is a reboot into creating my own Emacs
configuration, while extracting what I need from scimax, while still keeping
the entire distribution accessible.

** Inspiration

[[https://dustinlacewell.github.io/emacs.d/][Dustin Lacewell]]'s encouragement and help pretty much got me started and through
the pain of the initial iterations. Come join us on ##apoptosis on irc.

** Other literate configs

** TODO Shortcuts and links 

This is an attempt to use org-ref's index method to list specific headings

- [[index:-* scimax][scimax Active stuff]]
- 
...
- [ ] Check if the entire configuration loads when the straight folder is deleted.
- [ ] Figure out freezing packages
- [ ] Fix the jit and font lock issues
- [ ] Figure out optimal method of capturing tasks : maybe using org-projectile
...
* Org-mode related packages
  ...
  - Note taken on [2020-03-13 Fri 18:04] \\
    The agenda and capture mechanics should be integrated with the config of scimax-org.el or conversely, I need to consider extracting relevant information from scimax-org.el into my config. Scimax is already modified at the moment to incorporate straight.el
...
Eventually, I hope to have the most common commands mapped to my own hydra. For
now though...
...
* Scimax stuff
These packages and customisations are the ones I enjoy using from Scimax. A
bunch of changes were required to accomodate the usage of the Org packagge from straight.el
...
:PROPERTIES:
:ID:       FCDEBD56-8F22-458F-84F5-D3FAEBCD6B77
:END:

***
:PROPERTIES:
:ID:       CFE2496D-BF83-4687-B22C-30002A9BBF4D
:END:
...
*** ox-ipynb
:PROPERTIES:
:ID:       9DA015F2-6FE0-471D-9E16-4FF514268F40
:END:
...
** Export setup
   :PROPERTIES:
   :ID:       ED7CF454-297A-41D9-A151-B514D476E4AD
   :END:
...
The packages in this section are not enabled by default.
...
*** CANCEL Scimax + Elfeed-org and elfeed-goodies setup [/]
:PROPERTIES:
