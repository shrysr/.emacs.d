...
This will help with different settings for different brains. Eventually, I hope
I can use the same settings. 
...
For the few occassionst that I use the buffer-list command, I think the bufler
